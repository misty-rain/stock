...
package com.mistyrain.cat_foundation.support.net;
...
public class NetStateReceiver extends BroadcastReceiver {
    ...
    public final static String CUSTOM_ANDROID_NET_CHANGE_ACTION = "com.mistyrain.cat_foundation.net.conn.CONNECTIVITY_CHANGE";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equalsIgnoreCase(ANDROID_NET_CHANGE_ACTION) || intent.getAction().equalsIgnoreCase(CUSTOM_ANDROID_NET_CHANGE_ACTION)) {
            if (!NetUtils.isNetworkAvailable(context)) {
                LogProxy.i(TAG, "<--- network disconnected --->");
                isNetAvailable = false;
            } else {
                LogProxy.i(TAG, "<--- network connected --->");
                isNetAvailable = true;
